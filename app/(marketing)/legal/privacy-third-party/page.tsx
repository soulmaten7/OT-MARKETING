...
export const metadata: Metadata = {
    ...
    description: "One Trillion 제3자 정보 제공 동의 약관 시안 (변호사·법무법인 매칭 광고주 제공 시).",
};
        ...
        <main className="max-w-3xl mx-auto px-6 py-12 bg-white text-gray-900">
            ...
            <section className="mb-6">
                ...
                <p className="text-sm leading-relaxed">
                    One Trillion 과 광고 계약을 체결한 변호사·법무법인 (등급 A/B 매칭 시).
            ...
            <section className="mb-6">
                ...
                <p className="text-sm leading-relaxed">
                    One Trillion 은 변호사·법무법인의 의뢰인 직접 영업·수임료 % 정산을 일체 수행하지 않습니다.
