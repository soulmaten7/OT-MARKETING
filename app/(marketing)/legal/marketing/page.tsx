...
export const metadata: Metadata = {
    ...
    description: "One Trillion 마케팅 정보 수신 동의 약관 시안 (선택 동의).",
};
    ...
    return (
        <main className="max-w-3xl mx-auto px-6 py-12 bg-white text-gray-900">
            ...
            <section className="mb-6">
                ...
                <p className="text-sm leading-relaxed">OTMarketing</p>
            </section>
            ...
            <section className="mb-6">
                ...
                <p className="text-sm leading-relaxed">
                    이용자는 언제든 수신 거부 가능. 이메일 하단 unsubscribe 링크 또는 SMS 답신 "거부" 또는 One Trillion 고객센터 연락.
                </p>
            </section>
