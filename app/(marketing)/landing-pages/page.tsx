...
export const metadata: Metadata = {
    title: "셀프 랜딩페이지 — OTMarketing (곧 출시)",
    description:
        "14 업종 풀 사이즈 랜딩페이지를 코드 없이 1분 만에. 결제·예약·CRM 자동화 통합. 곧 출시 — 1순위 알림 받기.",
    openGraph: {
        title: "OTMarketing 셀프 랜딩페이지 — 곧 출시",
        description:
            ...
            <section className="bg-gradient-to-br from-[var(--navy-900)] via-[var(--navy-800)] to-[var(--navy-900)] text-white pt-32 pb-20 md:pt-40 md:pb-28">
                <div className="ot-container">
                    <div className="max-w-3xl">
                        <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-[var(--gold-500)]/15 rounded-full text-sm font-medium mb-6 ring-1 ring-[var(--gold-500)]/40 text-[var(--gold-500)]">
                            <span className="w-2 h-2 bg-[var(--gold-500)] rounded-full"></span>
                            곧 출시 · 셀프 랜딩페이지
                        </span>
                        <h1 className="font-display text-4xl md:text-6xl font-bold leading-tight mb-6">
                            진짜 매출을 만드는<br />
                            <span className="text-[var(--gold-500)]">풀 사이즈 랜딩페이지</span>.
                        </h1>
                        ...
                        <a
                            href="#pre-register"
                            className="inline-flex items-center justify-center px-8 py-4 bg-[var(--gold-500)] hover:bg-[var(--gold-600)] text-[var(--navy-900)] font-bold rounded-full transition-colors"
                        >
                            1순위 알림 신청 →
                        </a>
                    </div>
