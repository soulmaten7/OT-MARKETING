...
import { ImagePlaceholder } from "@/components/sections/ads-mockup/ImagePlaceholder";
    ...
    return (
        <div className="w-full h-full flex flex-col bg-white" style={{ fontFamily: 'Roboto, system-ui, sans-serif' }}>
            <div className="flex items-center justify-between px-3 py-2 border-b border-gray-200 flex-shrink-0">
                <div className="font-black text-[12px] text-gray-900 tracking-tight">PROPERTY NEWS</div>
                <div className="text-[8px] text-gray-500">부동산 정보</div>
            </div>

            <div className="px-3 pt-2 pb-1 flex-shrink-0">
                <div className="text-[9px] font-bold text-[#EA4335] mb-1">[부동산]</div>
                <div className="text-[10px] font-bold text-gray-900 mb-1.5 leading-snug">OO 지역 아파트 시세, 매물 변동 분석</div>
                <div className="text-[8px] text-gray-500 mb-2">부동산 매거진 · 5시간 전</div>
            ...
            <motion.div whileHover={{ scale: 1.03 }} transition={{ duration: 0.5 }} className="mx-3 my-2 rounded-lg overflow-hidden border border-gray-200 shadow-md flex-shrink-0">
                <div className="flex">
                    <div className="w-[35%] bg-gradient-to-br from-[#D97706] to-[#78350F] relative aspect-square">
                    ...
                    <div className="flex-1 px-2.5 py-2 bg-white flex flex-col justify-between">
                        <div>
                            <div className="text-[11px] font-bold text-gray-900 leading-tight mb-1">지역 매물 안내</div>
                            <div className="text-[8px] text-gray-600 leading-snug">공인중개사 자격 등록</div>
                        </div>
                ...
                <div className="px-2 py-1 bg-gray-50 flex items-center justify-between border-t border-gray-200">
                    <div className="flex items-center gap-1.5">
                        ...
                        <div className="text-[7px] text-gray-500">공인중개사 OO · 광고</div>
                    </div>
            ...
            <div className="flex-1 px-3 py-1">
                ...
                <div className="mt-2 pt-2 border-t border-gray-100">
                    ...
                    <div className="flex items-center gap-2 p-1.5 border border-gray-100 rounded">
                        <div className="w-7 h-7 bg-[#FEF3C7] rounded flex-shrink-0" />
                        <div>
                            <div className="text-[9px] font-bold text-gray-700 leading-tight">지역 시세 비교 정리</div>
                            <div className="text-[7px] text-gray-400">PROPERTY NEWS</div>
                        </div>
                    </div>
                </div>
            </div>
