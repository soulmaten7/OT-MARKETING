    ...
    return (
        <div className="w-full h-full flex flex-col bg-white" style={{ fontFamily: 'Roboto, system-ui, sans-serif' }}>
            <div className="flex items-center justify-between px-3 py-2 border-b border-gray-200 flex-shrink-0">
                <div className="font-black text-[12px] text-gray-900 tracking-tight">FINANCE NEWS</div>
                <div className="text-[8px] text-gray-500">경제 정보</div>
            </div>

            <div className="px-3 pt-2 pb-1 flex-shrink-0">
                <div className="text-[9px] font-bold text-[#EA4335] mb-1">[경제]</div>
                <div className="text-[10px] font-bold text-gray-900 mb-1.5 leading-snug">국내 증시 변동성 확대, 개인 투자자 공부 수요 증가</div>
                <div className="text-[8px] text-gray-500 mb-2">경제 매거진 · 2시간 전</div>
            ...
            <motion.div whileHover={{ scale: 1.03 }} transition={{ duration: 0.5 }} className="mx-3 my-2 rounded-lg overflow-hidden border border-gray-200 shadow-md flex-shrink-0">
                <div className="flex">
                    <div className="w-[35%] bg-gradient-to-br from-[#1E3A5F] to-[#0A1628] relative aspect-square">
                    ...
                    <div className="flex-1 px-2.5 py-2 bg-white flex flex-col justify-between">
                        <div>
                            <div className="text-[11px] font-bold text-gray-900 leading-tight mb-1">시장 분석 정보</div>
                            <div className="text-[8px] text-gray-600 leading-snug">차트 분석 · 시황 안내</div>
                        </div>
                ...
                <div className="px-2 py-1 bg-gray-50 flex items-center justify-between border-t border-gray-200">
                    <div className="flex items-center gap-1.5">
                        ...
                        <div className="text-[7px] text-gray-500">투자 정보 OO · 광고</div>
                    </div>
            ...
            <div className="flex-1 px-3 py-1">
                ...
                <div className="mt-2 pt-2 border-t border-gray-100">
                    ...
                    <div className="flex items-center gap-2 p-1.5 border border-gray-100 rounded">
                        <div className="w-7 h-7 bg-[#FFF8E1] rounded flex-shrink-0" />
                        <div>
                            <div className="text-[9px] font-bold text-gray-700 leading-tight">차트 분석 공부 자료</div>
                            <div className="text-[7px] text-gray-400">FINANCE NEWS</div>
                        </div>
                    </div>
                </div>
            </div>
