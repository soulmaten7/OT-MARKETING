        ...
        <div className="w-full h-full flex flex-col bg-white" style={{ fontFamily: 'Pretendard, system-ui, "Apple SD Gothic Neo", sans-serif' }}>
            <div className="flex items-center gap-2 px-3 py-2 bg-white border-b border-gray-200">
                ...
                <div className="flex-1 flex items-center gap-1.5 bg-gray-50 px-2 py-1 rounded-md">
                    <span className="text-[12px] text-[#1F1F1F] font-semibold flex-1">병원 예약 안내</span>
            ...
            <div className="flex-1 px-3 py-3 bg-gradient-to-b from-[#F0FAFA] to-white relative">
                ...
                <div className="relative z-20">
                    ...
                    <div className="text-[10px] text-[#03C75A] font-semibold mb-1">clinic-oo.com</div>
                    ...
                    <div className="bg-[#E0F7FA] border-l-4 border-[#0891B2] px-3 py-2 rounded-r mb-3">
                        <div className="text-[10px] font-bold text-[#1F1F1F]">🏥 진료 예약 · 평일 9~18시 · 위치 안내</div>
                    </div>
                </div>
            </div>
            ...
            <div className="px-3 py-2 border-t border-gray-100 bg-gray-50 flex-shrink-0">
                ...
                <div className="text-[10px] text-gray-600">OO 진료 예약 / 진료 시간 / 비용 안내</div>
            </div>
        </div>
    );
}
