        ...
        <div className="w-full h-full flex flex-col bg-white" style={{ fontFamily: 'Pretendard, system-ui, "Apple SD Gothic Neo", sans-serif' }}>
            <div className="flex items-center gap-2 px-3 py-2 bg-white border-b border-gray-200">
                ...
                <div className="flex-1 flex items-center gap-1.5 bg-gray-50 px-2 py-1 rounded-md">
                    <span className="text-[12px] text-[#1F1F1F] font-semibold flex-1">렌탈 요금</span>
            ...
            <div className="flex-1 px-3 py-3 bg-gradient-to-b from-[#F0FAFF] to-white relative">
                ...
                <div className="relative z-20">
                    ...
                    <div className="text-[10px] text-[#03C75A] font-semibold mb-1">rental-oo.com</div>
                    ...
                    <div className="bg-[#E8F8FF] border-l-4 border-[#0099CC] px-3 py-2 rounded-r mb-3">
