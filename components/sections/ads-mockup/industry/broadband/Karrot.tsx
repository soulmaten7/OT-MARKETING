    ...
    return (
        <div className="w-full h-full flex flex-col bg-[#FAF7F2]" style={{ fontFamily: 'Pretendard, system-ui, sans-serif' }}>
            ...
            <div className="px-3 pt-3 pb-2 flex-shrink-0">
                <motion.div whileHover={{ scale: 1.03 }} transition={{ duration: 0.5 }} className="aspect-[4/3] rounded-2xl bg-gradient-to-br from-[#7C73FF] to-[#4834D4] flex items-center justify-center text-white relative overflow-hidden">
                    ...
                    <div className="relative z-20 text-center px-4">
                        <div className="text-[10px] font-bold tracking-widest mb-2 opacity-90">5G 무약정 요금</div>
            ...
            <div className="flex-1 px-3 pb-3 bg-[#FAF7F2]">
                ...
                <div className="flex items-start gap-2 mb-2">
                    <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-[#6C63FF] to-[#4834D4] flex items-center justify-center text-white font-bold text-xs flex-shrink-0">5G</div>
                    <div className="flex-1 min-w-0">
                        <div className="font-bold text-[12px] text-[#1F1F1F] leading-tight">통신사 OO</div>
                ...
                <div className="text-[10px] text-gray-700 leading-relaxed mb-2">
                    데이터 무제한, 가입비 없음, 약정 자유 선택.
                </div>
                <div className="flex items-center gap-3 text-[10px] text-gray-500">
                    <div className="flex items-center gap-0.5">
                        <Heart className="w-3 h-3" /> <span>67</span>
                    </div>
                    <div className="flex items-center gap-0.5">
                        <MessageCircle className="w-3 h-3" /> <span>15</span>
                    </div>
                    <span>· 30분 전</span>
                </div>
            </div>
