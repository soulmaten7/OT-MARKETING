            ...
            <div className="flex-1 border-t border-gray-100 flex flex-col overflow-hidden">
                ...
                <div className="flex items-center gap-2 px-3 py-2 flex-shrink-0">
                    ...
                    <div className="flex-1">
                        <div className="font-bold text-[11px]">법무법인 OO</div>
                ...
                <div className="flex-1 bg-gradient-to-br from-[var(--coral-500)] to-[var(--navy)] flex items-center justify-center text-white">
                    <div className="text-center px-4">
                        <div className="text-xl font-bold mb-1">월 변제금</div>
                        <div className="text-2xl font-bold">부담되시나요?</div>
                    </div>
                </div>

                {/* 액션 행 */}
                <div className="flex items-center gap-4 px-3 py-2 border-t border-gray-100 flex-shrink-0">
